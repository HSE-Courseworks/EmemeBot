...
### Работа с сервисом
Обработка и агрегация почтовых данных происходит автоматически. Удаления файлов из облачного хранилища так же происходит регулярно.
Для взаимодействия с сервисом, можно отправлять ему запросы через REST-API.
